...
## 2️⃣ 타이밍 가이드 (10분 갭)
각 단계에서 다음 단계로 넘어가기 전 **권장 대기 시간**을 description 끝에 포함하세요.
- 1단계(채소) 완료 후: "⏱️ 10분 정도 기다려주세요"
- 2단계(단백질) 완료 후: "⏱️ 5분 후 다음 단계로!"
- 마지막 단계는 타이머 불필요
...
**먹는 순서 그룹화:**
- 1단계: 채소류 반찬 (나물, 샐러드, 김치 등)
- 2단계: 단백질 반찬 (고기, 생선, 계란, 두부)
- 3단계: 밥 + 남은 반찬 + 국/찌개 함께
    ...
    "steps": [
      {
        "order": 1,
        "foodName": "브로콜리",
        "description": "식이섬유가 소화 효소 분비를 준비하여 위장 부담을 줄입니다. ⏱️ 10분 정도 기다려주세요."
      },
      {
        "order": 2,
        "foodName": "계란후라이",
        "description": "단백질이 포만감 호르몬을 자극합니다. 케찹과 함께 드세요. ⏱️ 5분 후 다음 단계로!"
      },
      {
        "order": 3,
        "foodName": "밥",
        "description": "이제 밥을 반찬과 함께 천천히 드세요. 밥공기 절반 정도가 적당합니다."
      }
    ],
